#!/usr/bin/env bash
# FROZEN at d5908698 (before the package-verify-cleanup-on-every-exit fix) — tools/tests/test_publish_gate_order.py's red instrument; never run for real, never updated.
