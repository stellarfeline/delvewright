...
# `pub const DSL_VERSION: &str = "0.23.0";` — the one `dsl_version` the engine
# accepts (ADR-0024).
...
#   | `DW0102` | The document's `dsl_version` is not the one this engine accepts, `0.23.0`. … |
#
...
# ``- **Campaign format**: `dsl_version` `0.23.0`.``
