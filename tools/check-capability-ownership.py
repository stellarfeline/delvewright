...
INTERACTION_SITES = {
    ...
    "ws_arm_fns": (
        ...
        "v0.11 closed the other half, and the owner's 2026-08-10 ruling decided WHO "
        "closes it: the answer is the general verb, and for a door the CAMPAIGN "
        "must write it — an unanswered door is `DW0429`, not a line the engine "
        "invents. A baked default would be the compiler making a design statement "
        "about this door's tone and never disclosing it. The door is now an "
        "ordinary consumer of the mechanism rather than the one pressable object "
        "in the engine with nothing to say."
    ),
    "shortcut_setup": (
