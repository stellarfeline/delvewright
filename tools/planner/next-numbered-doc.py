...
branch is claimed.
    ...
    tools/planner/next-numbered-doc.py spec        # docs/specs/spec-NNNN-*.md
    tools/planner/next-numbered-doc.py adr         # docs/adr/NNNN-*.md
    tools/planner/next-numbered-doc.py spec --list # every claimed number and its holder
