...
drawn by an image model at the design-alignment gate (`tools/creator/refimg.py`), before
...
Usage:
    ...
    tools/creator/refscore.py --sheet .sheets/zone2.json --reference .refimg/zone2.png \\
