...
reaches bash through `tools/ci/build-release-binaries.sh`'s `read_manifest()`, a
...
# tools/ci/check-shell-pipe-shortcircuit.py): rewriting a preserved experiment would
