...
#
# Usage:
#   tools/ci/build-release-binaries.sh --list-targets
#   tools/ci/build-release-binaries.sh --check-only          # every target, no link
#   tools/ci/build-release-binaries.sh --target <triple>     # build + archive one
#
...
# irrelevant; `tools/ci/check-python-shell-newlines.py` requires it of every python
