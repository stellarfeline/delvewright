...
the sha1 of each document it read so the derivation is auditable.
    ...
    python3 tools/maintenance/derive-client-langs.py            # pinned version from versions.toml
    python3 tools/maintenance/derive-client-langs.py --version 1.21.11 --rust
