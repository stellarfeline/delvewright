...
Usage::
    ...
    python3 tools/maintenance/extract-block-renames.py crates/dsl/data/block-renames-1.21.11.json
    python3 tools/maintenance/extract-block-renames.py --cache-dir /tmp/mcmeta out.json
