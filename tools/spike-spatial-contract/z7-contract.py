...
def contract(p):
    ...
    edges = [
        ...
        ("hearth", "loft", "walk", None),
        ("loft", "landing", "walk", None),
        ("landing", "threshold", "walk", None),
        ("threshold", "ring", "walk", None),
        ("landing", "lift-shaft", "drop", None),
    ...
    return {
        ...
        "entry": "stair-foot",
        "spaces": [{"name": n, "envelope": e, "box": b} for n, e, b in spaces],
        "no_body": [],
