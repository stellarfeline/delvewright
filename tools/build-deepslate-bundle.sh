...
# the renderer's whole browser side ships inside it. `crates/delvec/src/compiler/view/viewer/
...
out="$repo_root/crates/delvec/src/compiler/view/viewer/deepslate.bundle.js"
