...
| Obbe Vermeij (ex-Rockstar North technical director) on the GTA cinematic camera's origin, relayed by [TheGamer](https://www.thegamer.com/grand-theft-auto-cinematic-cam-origins-rockstar-trains/) / [GamesRadar+](https://www.gamesradar.com/games/grand-theft-auto/gta-3-dev-thought-riding-the-train-was-boring-which-led-to-the-creation-of-the-series-cinematic-camera-the-team-found-it-surprisingly-entertaining/); community shot names via [GTA Wiki](https://gta.fandom.com/wiki/Cinematic_Camera); the *Father/Son* camera-rig datamine via [PCGamesN](https://www.pcgamesn.com/grand-theft-auto-v/invisible-truck-camera) | Unlicensed web content — ideas-only | Confirms the core architecture: a small bag of discrete shot templates, selected per shot. Note the dossier records what these sources do **not** support: no public source gives GTA/RDR2 shot durations or cut triggers, so those numbers came from the editing literature above, not from Rockstar. |
