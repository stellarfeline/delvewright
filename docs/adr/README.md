...
| [0017](0017-toolchain-distribution.md) | Toolchain distribution: `cargo install delvec`, release shelf, CI-only publishing | Accepted (§3 superseded by ADR-0021; install default superseded by ADR-0023) |
...
| [0021](0021-creator-toolchain-rederived.md) | Creator toolchain re-derived: one distributed binary, registry Nucleation, off-the-shelf viewer core | Accepted (§2, §5 not yet implemented) |
...
| [0023](0023-creator-toolchain-as-decided.md) | Creator toolchain as decided: archive-first acquisition, source-build floor, lazy-loaded externals | Accepted |
