...
- **Status**: Accepted; §3's `delve-render` exclusion superseded by ADR-0021,
  and the consequence naming `cargo install delvec` the creator-facing install
  superseded by ADR-0023 (archives are the default; crates.io stays a path)
- **Date**: 2026-08-06
