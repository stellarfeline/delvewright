...
- The compiler library is `crates/compiler` (Rust-native, ADR-0011); the binary
  ...
  [`tools.md`](tools.md).
- Versions (as of this doc): `delvec 1.1.0`, `dsl 0.21.0`, `mc 1.21.11`.
