...
The `&'static str` code constants that remain in `delvec schem`, `delvec prefab` and
`delvec render` are deliberate: those diagnostics are about prefabs, schematics and
