...
- Versions (as of this doc): `delvec 1.1.0`, `dsl 0.19.0`, `mc 1.21.11`.
  ...
  every document in this repository with it in the same change. This line is
...
The `&'static str` code constants in `delve-schem`, `delve-admit` and
`delve-render` are about prefabs, schematics and renders, artifacts that carry
