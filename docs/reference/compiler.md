...
- **`delvec prefab seating --horizon <base>`** answers the pairing over a whole
  ...
  they disagree. `delvec prefab audit` runs `DW0887` over a whole library when
