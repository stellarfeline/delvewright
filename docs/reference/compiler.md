...
| Deliberate shorelines: the stage-7 `flood` verb (DSL **v0.9**), ambient-water reach computed and materialized, the tideline invariant `DW0394`/`DW0395` re-proved after every batch | spec-0029 |
