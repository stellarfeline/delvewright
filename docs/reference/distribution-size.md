...
The **harvested game-registry data is not a separate download**: 1,253,344 B of
...
### 4.3 Embedded harvested registry data: 1,253,344 B
...
| `block-appearance-1.21.11.json` | 252,086 |
