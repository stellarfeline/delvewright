...
| [spec-0050](spec-0050-a-place-is-detailed-inside-the-box-the-whole-gave-it.md) | A place is detailed inside the box the whole gave it — stage 6 of the map pipeline | Draft |
