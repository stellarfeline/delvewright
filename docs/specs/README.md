...
| [spec-0064](spec-0064-the-last-player-leaves.md) | The last player leaves, and the delve is built again — an optional container flag that returns a running delve to its built state once the online count has read zero for a whole window | Proposed |
