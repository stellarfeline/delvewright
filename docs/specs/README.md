...
| [spec-0024](spec-0024-release-pipeline.md) | Release pipeline — from green campaign branch to joinable delve | Proposed |
| [spec-0025](spec-0025-branch-complete-verification.md) | Branch-complete narrative verification | Proposed |
