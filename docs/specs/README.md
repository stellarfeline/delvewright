...
| [spec-0070](spec-0070-every-approved-image-is-answered.md) | Every approved image is answered — a build refuses a camera record that leaves an approved picture with no view of the built world, and the staging gate refuses a campaign with no camera record at all | Draft |
