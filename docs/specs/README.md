...
| [spec-0072](spec-0072-the-drawing.md) | The drawing — a place's detail as an ordered list of solids the engine executes: thirteen operations over a palette, reuse in the document, stair shapes derived, a gate claimed by the operation that paints it, every refusal addressed to the operation that made it | Draft |
