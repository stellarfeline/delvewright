...
| DEC-0074 | 2026-08-12 | Non-trivial ad-hoc shell is written for bash rather than the interactive shell — and the rule is stated with its limit, because it removes two of six recorded traps and a rule read as removing all six would be worse than none | `claude/debug-doctrine@2026-08-12` | unenforced | — |
| DEC-0075 | 2026-08-12 | The creator must have the Minecraft client jar — visual validation is indispensable, so it is a declared prerequisite alongside cargo and Python 3 | `owner/2026-08-12-client-jar-prerequisite` | open | — |
| DEC-0077 | 2026-08-13 | Never trade a user decision for disk space — the authoring/review archive split is rejected, and the general form binds beyond it | `owner/2026-08-13-no-archive-split` | unenforced | — |
| DEC-0078 | 2026-08-13 | Grandeur is playable content, not volume — a big empty room is a small building that costs more to walk across | `claude/grandeur-is-playable-content-not-volume@2026-08-13` | unenforced | — |
| DEC-0079 | 2026-08-13 | Work is routed to a tier by its CLASS, and the planner authors none of it — architecture and specs to Fable, content design to Opus, implementation unchanged | `claude/work-is-routed-to-a-tier-by-its-class-and-th@2026-08-13` | unenforced | — |
| DEC-0080 | 2026-08-14 | A decision put to the owner leads with the PROBLEM, never with the options — what was observed, what the thing is, then the choice with its costs | `claude/a-decision-put-to-the-owner-leads-with-the-p@2026-08-14` | unenforced | — |
| DEC-0081 | 2026-08-14 | A decision session is ONE question at a time, and no work starts inside it — record the ruling, present the next, execute the whole batch afterwards | `claude/a-decision-session-is-one-question-at-a-time@2026-08-14` | unenforced | — |
| DEC-0082 | 2026-08-14 | Every validation authoring needs must be runnable on the creator's own machine — source build is the guarantee, binary distribution only an optimisation, and every skill owns an Init section | `claude/every-validation-authoring-needs-must-be-run@2026-08-14` | unenforced | — |
