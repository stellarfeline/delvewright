...
impl fmt::Display for ScopeAt {
    fn fmt(&self, f: &mut fmt::Formatter<'_>) -> fmt::Result {
        write!(
            f,
            "local {}x{}x{} (x\u{2192}world {}, y\u{2192}world {}, z\u{2192}world {}; world box \
             corner {},{},{} size {}x{}x{})",
            self.local[0],
            self.local[1],
            self.local[2],
