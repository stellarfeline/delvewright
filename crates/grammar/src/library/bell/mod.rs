...
//! [`hall_keep`]) — because those are facts about the zone's box that no piece of
//! vocabulary can know. One of the seven zones here writes nothing at all; the
//! other six write only that.
//!
