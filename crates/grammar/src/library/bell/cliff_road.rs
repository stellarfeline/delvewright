...
/// The zone's **design box** — the region the campaign expands this program
/// over (REMAKE §3).
///
/// The crag, cut by an inlet: two four-cell road bands either side of a
...
pub const REGION: [u32; 3] = [11, 13, 40];
