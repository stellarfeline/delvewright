...
const SRC = join(HERE, "..", "src", "compiler", "view", "viewer", "controls.js");
const PAGE = join(HERE, "..", "src", "compiler", "view", "viewer", "page.js");
...
const CSS = readFileSync(join(HERE, "..", "src", "compiler", "view", "viewer", "page.css"), "utf8");
const HTML = readFileSync(join(HERE, "..", "src", "compiler", "view", "viewer", "page.html"), "utf8");
