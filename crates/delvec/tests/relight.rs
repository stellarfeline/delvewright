...
fn relight_and_timeweather_emit_byte_identically() {
    ...
    c.world.dsl_version = DSL_VERSION.to_string();
...
fn render_plan_lighting_stamp_follows_the_declarations() {
    ...
    c1.world.dsl_version = DSL_VERSION.to_string();
    ...
    c2.world.dsl_version = DSL_VERSION.to_string();
...
fn dw0210_on_a_built_site_plan_names_the_rooms_and_a_reachable_remedy() {
    let dir = common::repo_root().join("crates/delvec/tests/fixtures/blockout");
