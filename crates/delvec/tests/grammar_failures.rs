...
use delvec::grammar::eval::EvalError;
use delvec::grammar::geom::Axis;
use delvec::grammar::ir::{Program, ProgramError};
use delvec::grammar::orient::OrientError;
use delvec::grammar::split::SplitError;
use delvec::grammar::{Box3, ExpandError, ExpandOptions, GuardLeaf, Limits, expand};
...
fn exhaustion(
    ...
    &str,
    &delvec::grammar::ScopeAt,
    &[delvec::grammar::RejectedAlternative],
    &[String],
) {
    match err {
