...
fn a_local_frame_inside_a_claimed_space_keeps_the_frame_and_the_claim() {
    ...
    let contract =
        delvec::grammar::export::contract_metadata(&out).expect("the program declares a contract");
    assert!(
