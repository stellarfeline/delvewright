...
fn worldless_campaign(volley_anchor: &str) -> Campaign {
    let quests = format!(
        r#"{{
  "dsl_version": "0.22.1", "campaign_id": "hello-world", "stage": "quests",
  "content": {{
    "quests": [ {{
      "id": "quest/open-the-door",
      "trigger": {{ "type": "campaign-start" }},
    ...
    parse_campaign(&RawCampaign {
        world: r#"{
  "dsl_version": "0.22.1", "campaign_id": "hello-world", "stage": "world",
  "content": {
  ...
  "content": { "npcs": [] }
        ...
        classes: read_hw("classes.json"),
        quest_plan: r#"{
  "dsl_version": "0.22.1", "campaign_id": "hello-world", "stage": "quest-plan",
  "content": {
