...
use delvec::grammar::export::{ExportError, export_zone};
use delvec::grammar::gates;
use delvec::grammar::ir::{Cond, Material, Node, Paint, Program};
use delvec::grammar::library::broken_grate::broken_grate;
use delvec::grammar::library::far_side_bar::far_side_bar;
...
fn grate_with_bare_bars() -> Program {
    ...
    let bars = vec![delvec::grammar::ir::Alternative::new(fill_state(
        "iron_bars",
    ))];
...
fn a_state_that_omits_a_property_reds_the_completeness_gate() {
    ...
    program.rules.insert(
        ...
        vec![delvec::grammar::ir::Alternative::new(fill_state(
...
fn a_reorientation_below_the_guard_voids_the_pin() {
    ...
    use delvec::grammar::ir::{Alternative, AxisSpec, Reorient};
