...
Prebuilt archives — Linux (x86-64 and arm64, glibc), macOS (Apple Silicon and
Intel), Windows (x86-64), each with a published SHA-256 — are on the
[releases page](https://github.com/stellarfeline/delvewright/releases/latest).
Every archive carries the whole binary, GPU rendering included.
...
never downloaded, bundled or redistributed by this tool. Point them at it with
...
- **Campaign format**: `dsl_version` `0.23.0`, the one number this engine accepts.
