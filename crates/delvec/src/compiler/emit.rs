    ...
    let (moves, actor_moves, wave_placements, wave_rings, lane_routes, payload_plans): (
    ...
    ) = if assembles_world(plan) {
        {
            ...
            let (moves, actor_moves) = if crate::compiler::nav::needs_world(plan) {
                ...
                let lethal_seats =
                    crate::compiler::lethal::check_respawn_seats(plan, campaign_spawn(plan))?;
...
struct WaveGeometry<'a> {
    ...
    lanes: &'a crate::compiler::nav::LaneRoutes,
...
fn affordances(plan: &Plan) -> Vec<crate::compiler::affordance::Affordance> {
    let mut out = Vec::new();
...
fn lethal_box(v: &crate::compiler::plan::LethalVolumePlan) -> String {
    let (lo, hi) = v.region;
    box_selector_args(lo, hi)
}
...
fn loot_setup(loot: &[crate::compiler::plan::LootPlan]) -> Vec<String> {
    let mut out = Vec::new();
    for l in loot {
        let c = l.cell;
...
struct VolleyEmit {
    key: String,
    geom: crate::compiler::nav::VolleyGeometry,
    projectile: String,
    salvos: u32,
    interval: u32,
}
...
struct CollapseEmit {
    key: String,
    geom: crate::compiler::nav::CollapseGeometry,
...
/// merely fixed.
fn cast_ladder_watch_claim(plan: &Plan) -> crate::compiler::watch::Claim {
    let casts = crate::compiler::cast::npc_casts(plan.campaign);
...
/// green.
fn cast_bark_watch_claims(plan: &Plan) -> Vec<crate::compiler::watch::Claim> {
    use crate::compiler::cast::SceneAction;
    let casts = crate::compiler::cast::npc_casts(plan.campaign);
    plan.npcs
        .iter()
...
/// loop skipped is.
fn wave_census_watch_claim(plan: &Plan) -> crate::compiler::watch::Claim {
    crate::compiler::watch::Claim {
...
fn timed_gate_watch_claim(plan: &Plan) -> crate::compiler::watch::Claim {
    crate::compiler::watch::Claim {
        mechanic: "timed-gate",
        families: vec![
...
fn kill_reward_watch_claim(plan: &Plan) -> crate::compiler::watch::Claim {
    crate::compiler::watch::Claim {
...
fn objective_activation_watch_claim(plan: &Plan) -> crate::compiler::watch::Claim {
    crate::compiler::watch::Claim {
...
fn npc_talk_watch_claim(plan: &Plan) -> crate::compiler::watch::Claim {
    crate::compiler::watch::Claim {
        mechanic: "npc-talk",
...
fn class_apply_watch_claim(plan: &Plan) -> crate::compiler::watch::Claim {
    crate::compiler::watch::Claim {
...
fn env_trigger_watch_claims(plan: &Plan) -> Vec<crate::compiler::watch::Claim> {
...
fn actor_watch_claim(plan: &Plan) -> crate::compiler::watch::Claim {
    crate::compiler::watch::Claim {
        mechanic: "actor",
...
fn dialogue_mask_watch_claims(plan: &Plan) -> Vec<crate::compiler::watch::Claim> {
    plan.npcs
        .iter()
