...
//!
//! Nav models a stair as a full cube ([`crate::compiler::assembled::collision_top_16`]
...
use crate::compiler::assembled::{base_id, state_value};
use crate::compiler::failure::Failure;
use crate::compiler::plan::Plan;
use crate::compiler::solver::Facing;
...
fn check_riser(
    ...
    let solid = |c: [i32; 3]| {
        blocks
            .get(&c)
            .is_some_and(|n| !crate::compiler::assembled::is_air(n))
    };
