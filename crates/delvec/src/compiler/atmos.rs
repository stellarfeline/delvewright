...
use crate::compiler::registry::FullSoundRegistry;
...
pub const DW_SOUND_UNKNOWN: DwCode = DwCode::new("DW0326", ExitTier::Build);
...
pub const DW_ART_GLYPH_UNCOVERED: DwCode = DwCode::new("DW0328", ExitTier::Build);
...
pub const DW_PLAYSOUND_ACTOR_UNSUPPORTED: DwCode = DwCode::new("DW0335", ExitTier::Build);
...
/// and [`crate::compiler::textfit`]'s width model cannot drift apart.
...
fn atlas_png() -> Vec<u8> {
    ...
    crate::compiler::png::encode_rgba_stored(width as u32, height as u32, &px)
}
...
/// ([`crate::compiler::snapshot`]/[`crate::compiler::blocking`]), which burns the *same* original
