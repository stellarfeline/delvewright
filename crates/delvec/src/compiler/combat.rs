...
fn seated_hostiles(
    ...
    for wave in waves {
        ...
        for (entity, cell) in crate::compiler::plan::wave_seats(wave, cells) {
...
mod tests {
    ...
    fn a_walled_in_hostile_is_dw0471() {
        ...
        solid.remove(&[0, 1, 0]);
        let world =
            World::from_occupancy(occ(solid), crate::compiler::nav::Premises::geometry_only());
        let seated = vec![(
            "wave/pit".to_string(),
        ...
        let open =
            World::from_occupancy(occ(solid2), crate::compiler::nav::Premises::geometry_only());
