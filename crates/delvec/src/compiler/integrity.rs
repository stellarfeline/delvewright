...
//! ([`crate::compiler::affordance`]) and the exported-waypoint self-check — a proof that
...
///
/// Shared with [`crate::compiler::seeding`], the other feature-blind proof read off the
