...
//!
//! DW0311 ([`crate::compiler::nav::check_critical_path`]) already proves an A* route connects
...
use crate::compiler::plan::{Plan, TimedGatePlan};
...
///
/// Shared with the visual-tier POV shot planner (`crate::compiler::render_plan`): the same
