...
//! it is made of are the staging vocabulary of [`crate::grammar::library`], and a `call`
...
//! be a loud `UnknownRule` from [`crate::grammar::ir::Program::validate`], never a quiet
...
use crate::grammar::ir::{
    Alternative, Cond, Expr, Mark, MarkAt, Material, Node, Program, Size, Split,
};
...
fn check_renames(
    ...
    for (from, to) in renames {
        ...
        if !crate::grammar::ir::is_kebab(to) {
