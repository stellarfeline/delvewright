...
//!
//! [`crate::grammar::library::drop_shaft`] builds its entry ledge `drop` blocks up and
...
//! inert rock except where the branch goes, and a [`crate::grammar::library::tee_passage`]
...
//! ([`crate::grammar::compose::include_renaming`]), exactly as Z6 does.
//!
//! # Missing (REMAKE §3 Z2)
//!
//! Nothing. **D** was the last entry with no rule at all
//! ([`crate::grammar::library::disarm_stand`] is it), and the other five were built rules
