...
//! [`crate::grammar::library::stair_flight`].** A flight is a walled shaft with a level
...
//! express is the hole — [`crate::grammar::library::lift_shaft`], the one rule this zone
...
//!
//! The landing is a [`crate::grammar::library::tee_passage`] whose side doorway opens on
...
//! anchor a zone has no right to. [`crate::grammar::library::hearth_ward`] landed in the
...
///
/// [`crate::grammar::library::stair_flight`] spends `landing_run` at each end of its box
