...
//! [`crate::grammar::compose::include`] and writes no encounter geometry of its own. A
...
//! [`Program::params`](crate::grammar::ir::Program::params) are the size/kind controls
//! and role bindings in [`Program::palette`](crate::grammar::ir::Program::palette) are
...
fn fill_block(block: crate::grammar::block::BlockState) -> Node {
    Node::Fill {
        material: crate::grammar::ir::Material::block(block),
    }
}
...
/// [`crate::grammar::ir::MarkIndex::Auto`] is how it names them anyway.
...
pub struct LibraryProgram {
    ...
    pub gates: crate::grammar::gates::Options,
...
const NO_CLAIM: crate::grammar::gates::Options = crate::grammar::gates::Options {
    traversable: false,
    allow_falls: false,
    symmetric: None,
...
const ROUTE: crate::grammar::gates::Options = crate::grammar::gates::Options {
    traversable: true,
    allow_falls: false,
    symmetric: None,
    reachable_floor: false,
...
const ROOFED: crate::grammar::gates::Options = crate::grammar::gates::Options {
    traversable: false,
    allow_falls: false,
    symmetric: None,
...
const MIRRORED_Y: crate::grammar::gates::Options = crate::grammar::gates::Options {
    traversable: false,
    allow_falls: false,
...
const fn entry(
    ...
    seed: u64,
    kind: Kind,
    gates: crate::grammar::gates::Options,
) -> LibraryProgram {
    LibraryProgram {
        id,
        build,
