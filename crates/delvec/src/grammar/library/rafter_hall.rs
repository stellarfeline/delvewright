...
use crate::grammar::ir::{ArithOp, AxisSpec, CmpOp, DimRef, Program, Reorient, Side};
...
fn corbel(top: crate::grammar::ir::Node) -> crate::grammar::ir::Node {
...
fn density_cap() -> crate::grammar::ir::Cond {
