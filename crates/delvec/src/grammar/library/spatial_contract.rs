...
//! about a model, and `crate::grammar::contract` is what asks it: this program is green
...
use crate::grammar::ir::{Bar, Contract, EXTERIOR, EdgeClass, Envelope, MarkAt, Node, Program};
