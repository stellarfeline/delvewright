...
use crate::grammar::ir::{Alternative, AxisSpec, CmpOp, DimRef, MarkAt, Program, Reorient};
...
pub fn broken_grate() -> Program {
    Program::new("broken_grate", "broken_grate")
            ...
            vec![alt_when(
                all_of(vec![
                    ...
                    cmp(
                        dim(DimRef::Y),
                        CmpOp::Ge,
                        par("head").arith(crate::grammar::ir::ArithOp::Add, int(2)),
                    ),
        ...
        // reorientation does not rewrite (`crate::grammar::orient` permutes and reflects
...
fn step(
    deeper: crate::grammar::ir::Node,
    near: crate::grammar::ir::Node,
) -> crate::grammar::ir::Node {
