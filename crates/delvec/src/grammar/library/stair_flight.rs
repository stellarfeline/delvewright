...
//! ([`crate::grammar::ir::Reorient::turned`]). Two lanes side by side in `X`, the second
...
//! under [`crate::grammar::ir::Reorient::turned`] is the worked example
//! (`tests/staging.rs`).
//!
//! # The gates
//!
...
fn last_climb() -> crate::grammar::ir::Expr {
    par("tread")
