...
//!
//! A [`Program`](crate::grammar::ir::Program) is a long-lived on-disk document: the
...
/// True if `version` may compose another program document.
pub fn has_include(version: &str) -> bool {
