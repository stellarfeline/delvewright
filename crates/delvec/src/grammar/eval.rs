...
use crate::grammar::ir::{ArithOp, CmpOp, Cond, DimRef, Expr, Paint};
...
/// value names are rebound by a [`Node::Bind`](crate::grammar::ir::Node::Bind). All three
...
/// about it.
///
/// The **root frame** is the program's own [`params`](crate::grammar::ir::Program::params)
/// and [`palette`](crate::grammar::ir::Program::palette): a declaration and a default at
...
/// [`crate::grammar::ir::Program::validate`] has already proved that a binding names
...
/// — [`crate::grammar::ir::Program::validate`] rejects them before expansion — but they
...
impl<'a> Scope<'a> {
    ...
    /// selection gives it its meaning (see [`crate::grammar::expand`]).
...
mod tests {
    ...
    fn a_frame_shadows_by_name_and_everything_else_falls_through() {
        ...
        let root_palette = BTreeMap::from([
            (
                "mass".to_string(),
                Paint::block(crate::grammar::block::BlockState::simple("stone")),
            ),
            (
                "cut".to_string(),
                Paint::block(crate::grammar::block::BlockState::air()),
            ),
        ]);
        ...
        let inner_palette = BTreeMap::from([(
            "cut".to_string(),
            Paint::block(crate::grammar::block::BlockState::simple("glass")),
        )]);
        ...
        assert_eq!(
            inner.paint("cut"),
            Some(&Paint::block(crate::grammar::block::BlockState::simple(
                "glass"
            )))
        );
        assert_eq!(
        ...
        assert_eq!(
            root.paint("cut"),
            Some(&Paint::block(crate::grammar::block::BlockState::air()))
        );
    }
