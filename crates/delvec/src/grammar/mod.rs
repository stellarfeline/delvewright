//! `delvec::grammar` — Box-Split Grammars as Delvewright's prefab back end
//! (spec-0027, phase 1).
//!
...
//!
//! ```
//! use delvec::grammar::{Box3, ExpandOptions, expand, library};
//!
...
//! # Provenance
//!
//! This module is a Rust port of the Box-Split Grammar core of
...
//! `LICENSE-GDMC25` beside the package manifest), which implements Markus
...
pub use expand::{
    Anchor, ExpandError, ExpandOptions, Expansion, Limits, Overrides, RejectedAlternative,
