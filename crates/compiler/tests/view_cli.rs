...
//! the `scene` and `panorama` subcommands' input/output error paths and their
//! Chunky-cache invalidation. Neither needs a GPU adapter nor the
//! (never-committed, EULA-gated) 1.21.11 client jar.
//!
