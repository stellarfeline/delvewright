...
const SURFACE: &[(&str, &str, Kind)] = &[
    ...
    ("HealthBar", "color", Reference),
    ("HealthBar", "style", Reference),
    ("HealthBar", "title", Inventoried),
    ...
    ("ShopOffer", "tooltip", Inventoried),
    ("Stake", "collected_message", Inventoried),
    ("Stake", "marker_item", Reference),
