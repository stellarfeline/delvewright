...
impl Horizon {
    ...
    /// True when this declaration needs the v0.12 surface: the object form, or
    /// any shorthand beyond the v0.6 `"void"`/`"ocean"` pair.
    pub fn needs_v12(&self) -> bool {
        !matches!(
            self,
...
pub struct QuestsContent {
    ...
    /// against in any gate. Empty/absent in pre-0.10 campaigns (reserved
...
// ---------------------------------------------------------------------------
// Stage 5 — runtime state (DSL v0.10, spec-0031)
// ---------------------------------------------------------------------------
